...
# maintining ports - portupgrade -arR will 
# recursively keep ports uptodate, if cvsup ports regularly.
...
echo `$dd` start_rebuildworld >> $log
...
#run so that it automatically installs 
# new config files, and puts any diffs into /var/tmp/temproot.xxx
mergemaster -ia
